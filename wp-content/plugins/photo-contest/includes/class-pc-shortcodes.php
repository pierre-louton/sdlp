...
class PC_Shortcodes {
    ...
    private function enqueue_jury_assets(): void {
        wp_enqueue_style( 'pc-jury', PC_PLUGIN_URL . 'public/css/pc-jury.css', [], PC_VERSION . '.6' );
        wp_enqueue_script( 'pc-jury', PC_PLUGIN_URL . 'public/js/pc-jury.js', [], PC_VERSION . '.6', true );
