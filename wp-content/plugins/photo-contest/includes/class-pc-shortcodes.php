...
class PC_Shortcodes {
    ...
    private function enqueue_catalogue_assets(): void {
        wp_enqueue_style( 'pc-catalogue', PC_PLUGIN_URL . 'public/css/pc-catalogue.css', [], PC_VERSION . '.2' );
    ...
    private function enqueue_jury_assets(): void {
        wp_enqueue_style( 'pc-jury', PC_PLUGIN_URL . 'public/css/pc-jury.css', [], PC_VERSION . '.2' );
        wp_enqueue_script( 'pc-jury', PC_PLUGIN_URL . 'public/js/pc-jury.js', [], PC_VERSION . '.2', true );
    ...
    private function enqueue_gallery_assets(): void {
        wp_enqueue_style( 'pc-gallery', PC_PLUGIN_URL . 'public/css/pc-gallery.css', [], PC_VERSION . '.4' );
        wp_enqueue_script( 'pc-gallery', PC_PLUGIN_URL . 'public/js/pc-gallery.js', [], PC_VERSION . '.4', true );
